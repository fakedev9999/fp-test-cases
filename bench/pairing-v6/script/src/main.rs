...
const GUEST_ELF: sp1_build::Elf = sp1_build::include_elf!("pairing-guest");
...
fn main() {
    ...
    println!("=== BN254 Pairing Benchmark (SP1 v6) ===");
    println!("Pairings: {n}");
    println!(
        "Total instructions: {}",
    ...
    let output_path = format!("output/pairing-v6-n{n}.json");
